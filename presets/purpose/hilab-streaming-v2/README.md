...
Dev workflow preset for the Hilab streaming platform v2 (NestJS + Next.js + SRS + GraphQL).
...
Team plugin: `ssh://git@gitlab.hilab.cloud:2424/hilabaikit/claudekit.git` (packages/hilab-streaming)
