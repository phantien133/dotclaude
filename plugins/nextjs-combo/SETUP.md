...
### terraform `[mcp_server]` *(moderate setup)*

**Install:**
```sh
Requires Docker. Pulls hashicorp/terraform-mcp-server:0.4.0. Set TFE_TOKEN env var for Terraform Cloud/Enterprise access.
```

**Docs:** https://github.com/hashicorp/terraform-mcp-server

**Notes:** Infrastructure-as-Code automation for AWS/cloud provisioning. Optional — only needed when working on Terraform/IaC. Pairs with the security-review skill's cloud-infrastructure-security checklist.
